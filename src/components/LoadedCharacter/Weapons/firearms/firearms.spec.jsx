...
import CharacterFirearms from './index';
...
const hydratedFirearmDoube = {
  name: 'hydrated firearm',
};

jest.mock('../../../../data/firearms/hydrate', () => ({
  __esModule: true,
  hydrateFirearmByObject: () => hydratedFirearmDoube,
}));

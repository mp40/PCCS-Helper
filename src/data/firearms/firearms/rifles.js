...
export const rifles = Object.freeze({
  ...
  M4: {
    ...
    projectiles: [
      {
        type: 'FMJ',
        pen: [15, 14, 13, 11, 9.9, 6.3, 4.0, 2.6],
        dc: [6, 6, 6, 6, 5, 3, 2, 2],
      },
      {
        type: 'AP',
        pen: [21, 19, 18, 16, 14, 8.6, 5.5, 3.5],
        dc: [6, 6, 6, 5, 4, 3, 2, 2],
      },
      {
        type: 'SUB',
        pen: [3.4, 3.2, 2.9, 2.6, 2.2, 1.4, 0.9, 0.6],
        dc: [2, 2, 2, 2, 2, 2, 2, 1],
      },
    ],
  ...
  'M1 Carbine': {
    ...
    rt: 8,
    rof: '*',
    mag: [{ type: 'Mag', weight: 0.7, cap: 15, qty: 0 }, { type: 'Mag', weight: 1.1, cap: 30, qty: 0 }],
    kd: 5,
    sab: 4,
  ...
  'M2 Carbine': {
    ...
    rt: 8,
    rof: '*8',
    mag: [{ type: 'Mag', weight: 1.1, cap: 30, qty: 0 }, { type: 'Mag', weight: 0.7, cap: 15, qty: 0 }],
    kd: 5,
    sab: 4,
    aim: improvedRifle11Aims,
    projectiles: [averageRifle30CarbineFMJ],
